...
function transformToLis(obj){
  ...
  for (let i = 0; i < firstArray.length; i++) {
    secondArray.push(`<li>${firstArray[i][0]}: ${firstArray[i][1]}</li>`);
  }
  return secondArray;
}
/* ------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------ */
const addValues = (arr) => {
  let newArray = arr.reduce((red,value,index)=>{
    red = red + value;
    return red;
  },0);
  return newArray;
...
const addPurchases = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((red,value,index)=>{
    red = red + value.purchasePrice;
    return red;
  },0);
  return newArr;
};
...
const countNumberOfElements = (arr) => {
  let arrLength = arr.reduce((red,value,index)=>{
    index++;
    return index;
  });
  return arrLength;
